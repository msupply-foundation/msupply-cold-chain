...
export declare class BleService {
    ...
    monitorCharacteristic: (device: TypedDevice, callback: MonitorCharacteristicCallback<boolean | SensorLog[] | InfoLog | DataLog>) => Promise<boolean | SensorLog[] | InfoLog | DataLog>;
